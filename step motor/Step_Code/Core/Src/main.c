...
uint8_t step_config_matlab;
int32_t step_freq_matlab;
int32_t pwm_matlab;
int32_t freq_matlab;
...
float torque_matlab = 0;
float load_cell = 0;
float wcs1_offset_matlab = 0;
float wcs2_offset_matlab = 0;
...
//		AS5600_get_angle(as5600, &Angle);
//		AS5600_get_rawAngle(as5600, &rawAngle);
